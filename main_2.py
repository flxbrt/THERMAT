...
import os 
os.chdir(r'C:\Users\felix\Desktop\Aufräumen/script_directory')

import therm_functions as tfc

config = {'ID': 'Global Thermal Analysis Engine',
          'chamber': {
                'd_th': {'Value': 39.6e-3, 'Description': 'Throat Diameter [m]'},
                ...
                'epsilon_e': {'Value': 2.83, 'Description': 'Expansion Ratio [-]'}},
          'cooling': {
          ...
          'load point': {
                ...
                'ROF': {'Value': 2.5, 'Description': 'oxidizer to fuel ratio [-]'},
                'm_dot': {'Value': 0.81, 'Description': 'total mass flow in combustion chamber [kg/s]'},
                'T_oxidizer': {'Value': 296, 'Description': 'Oxidizer Injection Temperature [K]'},
